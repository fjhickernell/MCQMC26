...
[Multiple]{.alert} transformations map a multivariate Gaussian integral to a standard uniform integral
...
- Potential speedup from [multilevel]{.alert} methods (outside scope)
...
No universally best low discrepancy sequence, but let's keep looking
