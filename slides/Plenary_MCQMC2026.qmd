...
- Estimate/bound on error, $\displaystyle\biggl \lvert \int_{[0,1]^d} f(\vx) \, \dif \vx - \frac 1n \sum_{i=0}^{n-1} f(\vx_i) \biggr \rvert$

- At reasonalble cost, $\Order \bigl( n \$(f) \bigr) + ?$
